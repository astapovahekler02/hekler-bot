...
TEXTS = {
    ...
    "vacancies": [["Сварщик"], ["Арматурщик"], ["Бетонщик"], ["Электрик"], ["Слесарь судостроения"], ["Общестроительный рабочий"], ["Сборщик металлоконструкций"]],
}
...
async def vacancy(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    allowed_vacancies = {"Сварщик", "Арматурщик", "Бетонщик", "Электрик", "Слесарь судостроения", "Общестроительный рабочий", "Сборщик металлоконструкций"}
